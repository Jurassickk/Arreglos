...
document.addEventListener("DOMContentLoaded", function () {
   ...
   */
    ...
    if (tipo === 2) {
      ...
      for (iteracion = 0; iteracion < 3; iteracion++) {      //fila
        for (iteracion2 = 0; iteracion2 < 3; iteracion2++) {   //columna 
      ...
      for (iteracion = 2; iteracion < 5; iteracion++) {
        for (iteracion2 = 0; iteracion2 < 3; iteracion2++) {
          if (
            iteracion + iteracion2 === (iteracion2 + 1) * 2 ||           //para hallar los multiplos de 2        //"x" de la izquierda abajo
    ...
    if (tipo >= 5 && tipo <= 9) {
      for (let iteracion = 0; iteracion < 5; iteracion++) {
        Bingo[iteracion][tipo - 5] = Bingo[iteracion][tipo - 5]; //Reasigna cada elemento en la columna haciendo una resta de 5 con cada tipo de bingo
      }
    }
